...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerForContextMenu(tvCtxMenu); //뷰 객체(위젯 등..)에 ContextMenu를 등록함
...
// 컨텍스트 메뉴가 생성될때, 한번만 호출되는 콜백 메서드
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        Log.d("myapp","onCreateConextMenu");
...
// ContextMenu 의 메뉴아이템 항목을 선택(클릭) 했을 때 호출
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        int id = item.getItemId(); // 메뉴아이템의 id 값
            ...
            case 0:
                switch (id){
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        tvCtxMenu.setTextColor(Color.CYAN);
                        return true;
                }
                break;
            case 1:
                switch (id){
                    case 1:
                        ivCtxMenu.setImageResource(R.drawable.img03);
                        return true;
                    case 2:
                        ivCtxMenu.setImageResource(R.drawable.img04);
                        return true;
                    case 3:
                        ivCtxMenu.setImageResource(R.drawable.img07);
                        return true;
                }
                break;
