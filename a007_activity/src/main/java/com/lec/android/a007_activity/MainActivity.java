...
public class MainActivity extends AppCompatActivity {
    ...
    // onRestoreInstanceState() 는 onStart직후에 호출된다.
    @Override
    ...
    //액티비티 소멸 전에 호출된다. (주의 :  onPause뒤에 호출된다고 간주하지 말것!)
    //outState : <- 액티비티 정보 저장하여 나중에 onCreate 에서 사용 가능
    @Override
    public void onSaveInstanceState(@NonNull Bundle outState) {
        super.onSaveInstanceState(outState);
        Log.d("myapp","onSaveInstanceStrate");
