...
public class MainActivity extends AppCompatActivity {
    ...
    //음향 리소스 id
    private final int [] SOUND_RED = {R.raw.gun, R.raw.gun2, R.raw.gun3};


    //음향 id 값
    int [] soundId = new int [SOUND_RED.length];
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT> Build.VERSION_CODES.LOLLIPOP){
            //API 21 이상에서는 아래와 같이 SoundPool 생성
        ...
        //SoundPool 에 음향 리소스 들을  Load
        for(int i= 0;i<SOUND_RED.length;i++){
