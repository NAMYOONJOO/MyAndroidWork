...
public class MainActivity extends AppCompatActivity {
    ...
    public void mOnClick(View v){
        ...
        tvBackValue1.setText("작업스레드 값:" +backValue1);
        tvBackValue2.setText("작업스레드 값:" +backValue2);
    }// end mOnClick


    //안드로이드는 메인 쓰레드를 강제 종료시킬 수 없다.
    public void mOnClick2(View v){
        Thread.currentThread().stop(); //UnsupportedOperationException
    }// end mOnclick2

    //1. Thread 를 상속받은 직업스레드
