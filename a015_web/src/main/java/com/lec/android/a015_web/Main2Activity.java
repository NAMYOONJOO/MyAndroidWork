...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //WebView 세팅
        wv.getSettings().setJavaScriptEnabled(true);//자바스크립트 사용 여부 default : false
        ...
        btnWebView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wv.setWebChromeClient(new WebChromeClient()); //안하면 alert()같은 알림창ㅇ 안뜸
                wv.setWebViewClient(new WebViewClient()); //안하면 html내부에서 다른 페이지로 이동할 수 없다.
            }
        });
